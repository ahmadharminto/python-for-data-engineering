...
if __name__ == "__main__":
    ...
    assert check_province_list['success'] == True, f'Terdapat province yang tak dikenal, test result : {check_province_list}'

    covid_df['Total_Cumulative'] = covid_df['Cumulative_Death'] + covid_df['Cumulative_Recovered'] + covid_df['Cumulative_Active_Case']
    check_cumulative_case = covid_df.expect_column_pair_values_to_be_equal(column_A='Total_Cumulative', column_B='Cumulative_Case')
